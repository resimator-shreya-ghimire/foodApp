import type { FooterProps } from "./layout.data";

const Footer: React.FC<FooterProps> = ({ children, className = "", copyrightText = `© ${new Date().getFullYear()} MyFoodApp`, footerFields=[] }) => {
  return (
